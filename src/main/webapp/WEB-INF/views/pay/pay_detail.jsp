		   ...
		   <div class="col-8">
	    	<form action="reservation/complete" method="post" id="form-reserv">
				<div class="my-3">
					...
					<input class="form-control" type="text" placeholder="체크인시 필요한 정보입니다." name="reserName" id="reserName" value="${dto.name }">
				</div>
				<div class="my-3">
					<p class="form-label">휴대폰 번호</p>
					<p class="form-text">개인 정보 보호를 위해 안심번호로 숙소에 전송됩니다.</p>
					<div class="input-group">
						<input type="text" class="form-control" placeholder="체크인시 필요한 정보입니다." name="reserTel" id="reserTel" value="${dto.tel }">
