				...
				<div class="row mb-3" id="box-name-btn">
					...
					<c:forEach var="dto" items="${list}">
						<tr>
							...
							<td><img src="${path}/resources/images/${dto.event_mainphoto}" width="100px" height="100px"></td>
							<td><a class="btn btn-primary" href="${path}/admin/bannerDetail.do?banner_num=${dto.banner_num}">자세히보기</a></td>
						</tr>
					</c:forEach>
				</table>
				</div>
